...
from helpers.constants import SCREENSHOTS_DIR
...
class AISelectorHealer:
    ...
    def heal_selector(self, context: Context, exception: str, original_selector: str = "") -> str:
        ...
        suggested_selector, confidence, selector_type, selector_identifier = extract_selector_and_confidence(
            ai_response)
    ...
    try:
        ...
        if json_match:
            ...
            selector_identifier = str(
                json_data.get("selector_identifier")).lower()
        ...
        for pattern in confidence_patterns:
            ...
            if match:
                ...
                confidence = conf_value if conf_value.endswith(
                    '%') else f"{conf_value}%"
                break
